...
public class DataInitializer {
    ...
    public CommandLineRunner seedData(
        ...
        return args -> {
            ...
            seedMonthExpenses(expenseRepo, househead, son, mother, daughter, household, today);
            seedMonthExpenses(expenseRepo, househead, son, mother, daughter, household, today.minusMonths(1));
            seedMonthExpenses(expenseRepo, househead, son, mother, daughter, household, today.minusMonths(2));
    ...
    private void seedMonthExpenses(
            ExpenseRepository expenseRepo,
            User househead, User son, User mother, User daughter,
